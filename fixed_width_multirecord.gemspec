...
Gem::Specification.new do |s|
  s.name = %q{fixed_width_multirecord}
  s.version = "0.3.0"
...
Reshamelessly forked from Timon's version to add multi-line record support
  ...
  s.email = %q{jyanowitz@groupon.com}
  s.extra_rdoc_files = [
    "README.markdown",
     "TODO"
  ]
  s.files = [
    ".gitignore",
     ...
     "lib/fixed_width/line_parser.rb",
  ...
  s.homepage = %q{http://github.com/yanowitz/fixed_width_multirecord}
